              ...
              applications: prevJob.applications.map((app) =>
                app._id === application._id
                  ? {
                      ...app,
                      applicationStatus: "Accepted",
                      applicantName: data.applicant?.name || app.applicantName || "Unknown",
                    }
                  : app
              ),
            }));
      
            setPopupMessage(`Successfully hired ${application.applicantName || "Unknown"}`);
            setShowPopup(true);
      
            // Fetch updated jobs list
            fetchJobs();  // <-- Fetch the updated jobs list here
          ...
          jobs.map((job, index) => (
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Offered By: <span className="font-semibold">{job.offeredBy && job.offeredBy.name ? job.offeredBy.name : "Unknown"}</span>
              </p>
            ...
            <div className="fixed top-0 right-0 h-screen w-1/2 bg-white shadow-md overflow-y-auto z-50">
              ...
              <div className="p-6 mt-12">
                ...
                <p className="text-gray-700 mb-6 text-xl">
                  Offered By: <span className="font-semibold">{selectedJob.offeredBy && selectedJob.offeredBy.profile && selectedJob.offeredBy.profile.name ? selectedJob.offeredBy.profile.name : "Unknown"}</span>
                </p>
