    ...
    return (
        <div className="flex items-center justify-between bg-white border-b border-gray-300">
            <div className="flex items-center">
                ...
                <p className="p-4 cursor-pointer text-gray-800 hover:text-red-900 hover:bg-blue-500"><Link to="/" className="text-gray-800 hover:text-gray-900">Post Jobs</Link></p>
            </div>
